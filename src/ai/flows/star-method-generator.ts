...
export type StarMethodStoryGeneratorInput = z.infer<typeof StarMethodStoryGeneratorInputSchema>;
...
export type StarMethodStoryGeneratorOutput = z.infer<typeof StarMethodStoryGeneratorOutputSchema>;

export async function starMethodStoryGenerator(input: StarMethodStoryGeneratorInput): Promise<StarMethodStoryGeneratorOutput> {
