...
export type SpeakAnalysisInput = z.infer<typeof SpeakAnalysisInputSchema>;
...
export type SpeakAnalysisOutput = z.infer<typeof SpeakAnalysisOutputSchema>;

export async function speakAnalysis(input: SpeakAnalysisInput): Promise<SpeakAnalysisOutput> {
